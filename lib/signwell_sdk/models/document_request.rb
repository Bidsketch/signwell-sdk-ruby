...
module SignWell
  module Models
    class DocumentRequest
      ...
      # @return [Array<Array<FieldsInnerInner>>]
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::DocumentRequest` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::DocumentRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.draft = if attributes.key?(:draft)
                       attributes[:draft]
                     else
                       false
                     end

        self.self_sign = if attributes.key?(:self_sign)
                           attributes[:self_sign]
                         else
                           false
                         end

        self.with_signature_page = if attributes.key?(:with_signature_page)
                                     attributes[:with_signature_page]
                                   else
                                     false
                                   end
        ...
        self.text_tags = if attributes.key?(:text_tags)
                           attributes[:text_tags]
                         else
                           false
                         end
      ...
      def list_invalid_properties
        ...
        invalid_properties = []
        invalid_properties.push('invalid value for "files", files cannot be nil.') if @files.nil?
      ...
      def files=(files)
        raise ArgumentError, 'files cannot be nil' if files.nil?
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          draft == other.draft &&
          self_sign == other.self_sign &&
          with_signature_page == other.with_signature_page &&
      ...
      def hash
        [test_mode, files, name, subject, message, recipients, draft, self_sign, with_signature_page, expires_in,
         reminders, apply_signing_order, api_application_id, embedded_signing, embedded_signing_notifications, text_tags, custom_requester_name, custom_requester_email, redirect_url, allow_decline, allow_reassign, decline_redirect_url, language, metadata, fields, attachment_requests, copied_contacts, labels, checkbox_groups].hash
      end
