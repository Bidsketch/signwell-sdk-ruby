...
module SignWell
  module Models
    class DocumentTemplateResponse
      ...
      def hash
        [id, api_application_id, requester_email_address, custom_requester_name, custom_requester_email, name, subject, message, metadata, created_at, updated_at, placeholders, copied_placeholders, status, reminders, archived, embedded_edit_url, template_link, template_id, apply_signing_order, redirect_url, decline_redirect_url, language, expires_in, files, fields, allow_decline, allow_reassign, labels, checkbox_groups].hash
      end
