...
module SignWell
  module Models
    class TemplateFieldValuesInner
      ...
      def self.openapi_types
        {
          'api_id': :String,
          'value': :TemplateFieldValuesInnerValue
        }
      end
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::TemplateFieldValuesInner` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::TemplateFieldValuesInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
      ...
      def list_invalid_properties
        ...
        invalid_properties = []
        invalid_properties.push('invalid value for "api_id", api_id cannot be nil.') if @api_id.nil?
