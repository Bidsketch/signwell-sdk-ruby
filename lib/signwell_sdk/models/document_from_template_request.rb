    ...
    class DocumentFromTemplateRequest
      ...
      def self.openapi_types
        {
          ...
          'template_fields': :'Array<TemplateFieldValuesInner>',
          'files': :'Array<AdditionalFilesInner>',
          'fields': :'Array<Array<AdditionalFieldsInnerInner>>',
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::DocumentFromTemplateRequest` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::DocumentFromTemplateRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        if attributes.key?(:exclude_placeholders) && (value = attributes[:exclude_placeholders]).is_a?(Array)
        ...
        if attributes.key?(:template_fields) && (value = attributes[:template_fields]).is_a?(Array)
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          exclude_placeholders == other.exclude_placeholders &&
          draft == other.draft &&
          ...
          template_fields == other.template_fields &&
          files == other.files &&
          fields == other.fields &&
      ...
      def hash
        [test_mode, template_id, template_ids, name, subject, message, recipients, exclude_placeholders, draft,
         with_signature_page, expires_in, reminders, apply_signing_order, api_application_id, embedded_signing, embedded_signing_notifications, text_tags, custom_requester_name, custom_requester_email, redirect_url, allow_decline, allow_reassign, decline_redirect_url, language, metadata, template_fields, files, fields, attachment_requests, copied_contacts, labels, checkbox_groups].hash
      end
