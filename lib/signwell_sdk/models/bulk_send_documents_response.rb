...
module SignWell
  module Models
    ...
    class BulkSendDocumentsResponse
      # @return [String]
      attr_accessor :id
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::BulkSendDocumentsResponse` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::BulkSendDocumentsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
      ...
      def list_invalid_properties
        ...
        invalid_properties.push('invalid value for "documents", documents cannot be nil.') if @documents.nil?
      ...
      def hash
        [id, name, api_application_id, created_at, user_id, status, documents, current_page, next_page, previous_page,
         total_count, total_pages].hash
      end
