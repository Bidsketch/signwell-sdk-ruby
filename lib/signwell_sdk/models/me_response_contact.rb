    ...
    class MeResponseContact
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::MeResponseContact` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::MeResponseContact`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.alt_phone_number = attributes[:alt_phone_number] if attributes.key?(:alt_phone_number)

        self.website = attributes[:website] if attributes.key?(:website)

        self.initials = attributes[:initials] if attributes.key?(:initials)

        return unless attributes.key?(:archived)
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          alt_phone_number == other.alt_phone_number &&
