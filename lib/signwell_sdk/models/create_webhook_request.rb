    ...
    class CreateWebhookRequest
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::CreateWebhookRequest` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::CreateWebhookRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
      ...
      def list_invalid_properties
        ...
        invalid_properties = []
        invalid_properties.push('invalid value for "callback_url", callback_url cannot be nil.') if @callback_url.nil?
      ...
      def callback_url=(callback_url)
        raise ArgumentError, 'callback_url cannot be nil' if callback_url.nil?
      ...
      def hash
        [callback_url, api_application_id].hash
      end
