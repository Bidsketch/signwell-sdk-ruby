...
module SignWell
  module Models
    class DocumentTemplateRequest
      ...
      # @return [Array<Array<TemplateFieldsInnerInner>>]
      ...
      # @return [Array<TemplateAttachmentRequestsInner>]
      ...
      # @return [Array<TemplateCheckboxGroupsInner>]
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::DocumentTemplateRequest` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::DocumentTemplateRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
      ...
      def list_invalid_properties
        ...
        invalid_properties.push('invalid value for "placeholders", placeholders cannot be nil.') if @placeholders.nil?
      ...
      def placeholders=(placeholders)
        raise ArgumentError, 'placeholders cannot be nil' if placeholders.nil?
      ...
      def hash
        [files, name, subject, message, placeholders, copied_placeholders, draft, expires_in, reminders,
         apply_signing_order, api_application_id, text_tags, redirect_url, allow_decline, allow_reassign, decline_redirect_url, language, metadata, fields, attachment_requests, labels, checkbox_groups].hash
      end
