    ...
    class BulkSendValidateCsvResponse
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::BulkSendValidateCsvResponse` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::BulkSendValidateCsvResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.skip_row_errors = attributes[:skip_row_errors] if attributes.key?(:skip_row_errors)
        ...
        return unless attributes.key?(:apply_signing_order)
      ...
      def hash
        [bulk_send_csv, template_ids, skip_row_errors, api_application_id, name, subject, message,
         apply_signing_order].hash
      end
