    ...
    class TemplateFieldsInnerInner
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `SignWell::TemplateFieldsInnerInner` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `SignWell::TemplateFieldsInnerInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.placeholder_id = (attributes[:placeholder_id] if attributes.key?(:placeholder_id))
      ...
      # Custom attribute writer method with validation
      # @param [Object] placeholder_id Value to be assigned
      def placeholder_id=(placeholder_id)
        raise ArgumentError, 'placeholder_id cannot be nil' if placeholder_id.nil?
      ...
      def hash
        [x, y, page, placeholder_id, type, required, label, value, api_id, name, validation, fixed_width, lock_sign_date,
