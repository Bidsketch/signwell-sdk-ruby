    ...
    module V1
      ...
      class DocumentTemplateCreateParams < SignwellSDK::Internal::Type::BaseModel
        ...
        class Field < SignwellSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field::Type]
          required :type, enum: -> { SignwellSDK::V1::DocumentTemplateCreateParams::Field::Type }
          ...
          #   MM/DD/YYYY.
          #
          #   @return [Symbol, SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field::DateFormat, nil]
          optional :date_format, enum: -> { SignwellSDK::V1::DocumentTemplateCreateParams::Field::DateFormat }
          ...
          #
          #   @return [Symbol, SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field::Validation, nil]
          optional :validation, enum: -> { SignwellSDK::V1::DocumentTemplateCreateParams::Field::Validation }
          ...
          #
          #   @param type [Symbol, SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field::Type] Field type of the field. Valid field types: initials, signatures, checkbox, date
          #
          ...
          #
          #   @param date_format [Symbol, SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field::DateFormat] Date fields only: date format to use for the field. Valid values: MM/DD/YYYY, DD
          #
          ...
          #
          #   @param validation [Symbol, SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field::Validation] Text fields only: optional validation for field values. Valid values: numbers, l
          #
          ...
          # checkbox_groups parameter.
          #
          # @see SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field#type
          module Type
          ...
          # MM/DD/YYYY.
          #
          # @see SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field#date_format
          module DateFormat
            extend SignwellSDK::Internal::Type::Enum
          ...
          # alphanumeric, us_bank_routing_number, us_bank_account.
          #
          # @see SignwellSDK::Models::V1::DocumentTemplateCreateParams::Field#validation
          module Validation
            extend SignwellSDK::Internal::Type::Enum
