  ...
  module Models
    module V1
      ...
      class DocumentTemplateUpdateParams < SignwellSDK::Internal::Type::BaseModel
        ...
        #   placeholder.
        #
        #   @return [Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Placeholder>]
        required :placeholders,
                 -> { SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::V1::DocumentTemplateUpdateParams::Placeholder] }
        ...
        #
        #   @return [Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::AttachmentRequest>, nil]
        optional :attachment_requests,
                 -> { SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::V1::DocumentTemplateUpdateParams::AttachmentRequest] }
        ...
        #   all recipients.
        #
        #   @return [Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::CopiedPlaceholder>, nil]
        optional :copied_placeholders,
                 -> { SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::V1::DocumentTemplateUpdateParams::CopiedPlaceholder] }
        ...
        #
        #   @return [Array<Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field>>, nil]
        optional :fields,
                 -> { SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::V1::DocumentTemplateUpdateParams::Field]] }
        ...
        #
        #   @param placeholders [Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Placeholder>] Placeholders are generally job roles that must complete and/or sign the document
        #
        ...
        #
        #   @param attachment_requests [Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::AttachmentRequest>] Attachments that a recipient must upload to complete the signing process. Attach
        #
        ...
        #
        #   @param copied_placeholders [Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::CopiedPlaceholder>] Copied placeholders are emailed the final document once it has been completed by
        #
        ...
        #
        #   @param fields [Array<Array<SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field>>] Document fields placed on a document for collecting data or signatures from reci
        #
        ...
        class Placeholder < SignwellSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Placeholder} for more
          #   details.
          #
        ...
        class AttachmentRequest < SignwellSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {SignwellSDK::Models::V1::DocumentTemplateUpdateParams::AttachmentRequest} for
          #   more details.
          #
        ...
        class CopiedPlaceholder < SignwellSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {SignwellSDK::Models::V1::DocumentTemplateUpdateParams::CopiedPlaceholder} for
          #   more details.
          #
          #   @param name [String] Name of the placeholder.
          #
        ...
        class Field < SignwellSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::Type]
          required :type, enum: -> { SignwellSDK::V1::DocumentTemplateUpdateParams::Field::Type }
          ...
          #   MM/DD/YYYY.
          #
          #   @return [Symbol, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::DateFormat, nil]
          optional :date_format, enum: -> { SignwellSDK::V1::DocumentTemplateUpdateParams::Field::DateFormat }
          ...
          #
          #   @return [Array<String, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::Option::UnionMember1>, nil]
          optional :options,
                   -> { SignwellSDK::Internal::Type::ArrayOf[union: SignwellSDK::V1::DocumentTemplateUpdateParams::Field::Option] }
          ...
          #
          #   @return [Symbol, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::Validation, nil]
          optional :validation, enum: -> { SignwellSDK::V1::DocumentTemplateUpdateParams::Field::Validation }
          ...
          #   Some parameter documentations has been truncated, see
          #   {SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field} for more details.
          #
          ...
          #
          #   @param type [Symbol, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::Type] Field type of the field. Valid field types: initials, signatures, checkbox, date
          #
          ...
          #
          #   @param date_format [Symbol, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::DateFormat] Date fields only: date format to use for the field. Valid values: MM/DD/YYYY, DD
          #
          ...
          #
          #   @param options [Array<String, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::Option::UnionMember1>] Array of dropdown options (for dropdown/select fields only)
          #
          #   @param required [Boolean] Whether the field must be completed by the recipient. Defaults to `true` except
          #
          #   @param validation [Symbol, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::Validation] Text fields only: optional validation for field values. Valid values: numbers, l
          #
          #   @param value [Object] Varies according to the field type. Text fields accept strings or numbers. Date
          #
          ...
          # checkbox_groups parameter.
          #
          # @see SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field#type
          module Type
          ...
          # MM/DD/YYYY.
          #
          # @see SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field#date_format
          module DateFormat
            extend SignwellSDK::Internal::Type::Enum
          ...
          module Option
            ...
            variant -> { SignwellSDK::V1::DocumentTemplateUpdateParams::Field::Option::UnionMember1 }
            ...
            #   @return [Array(String, SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field::Option::UnionMember1)]
          end
          ...
          # alphanumeric, us_bank_routing_number, us_bank_account.
          #
          # @see SignwellSDK::Models::V1::DocumentTemplateUpdateParams::Field#validation
          module Validation
            extend SignwellSDK::Internal::Type::Enum
