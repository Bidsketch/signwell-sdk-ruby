    ...
    module V1
      ...
      class DocumentCreateFromTemplateParams < SignwellSDK::Internal::Type::BaseModel
        ...
        class Field < SignwellSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<String, SignwellSDK::Models::V1::DocumentCreateFromTemplateParams::Field::Option::UnionMember1>, nil]
          optional :options,
          ...
          #
          #   @param options [Array<String, SignwellSDK::Models::V1::DocumentCreateFromTemplateParams::Field::Option::UnionMember1>] Array of dropdown options (for dropdown/select fields only)
          #
          ...
          module Option
            ...
            variant -> { SignwellSDK::V1::DocumentCreateFromTemplateParams::Field::Option::UnionMember1 }
            ...
            #   @return [Array(String, SignwellSDK::Models::V1::DocumentCreateFromTemplateParams::Field::Option::UnionMember1)]
          end
