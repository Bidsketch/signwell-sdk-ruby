  ...
  module Models
    module V1
      class CheckboxGroup < SignwellSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, SignwellSDK::Models::V1::CheckboxGroup::Validation, nil]
        optional :validation, enum: -> { SignwellSDK::V1::CheckboxGroup::Validation }

        # @!method initialize(checkbox_ids:, group_name:, recipient_id:, exact_value: nil, max_value: nil, min_value: nil, required: nil, validation: nil)
        #   Some parameter documentations has been truncated, see
        #   {SignwellSDK::Models::V1::CheckboxGroup} for more details.
        #
        #   @param checkbox_ids [Array<String>]
        #
        #   @param group_name [String] A unique identifier for the checkbox group.
        #
        #   @param recipient_id [String] The recipient ID associated with the checkbox group.
        #
        ...
        #
        #   @param validation [Symbol, SignwellSDK::Models::V1::CheckboxGroup::Validation] Set requirements for the group of one or multiple selections by the recipient. D

        # Set requirements for the group of one or multiple selections by the recipient.
        # Defaults to minimum. Validation values: minimum, maximum, exact, range.
        #
        # @see SignwellSDK::Models::V1::CheckboxGroup#validation
        module Validation
