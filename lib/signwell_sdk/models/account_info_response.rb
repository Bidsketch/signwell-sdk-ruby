    ...
    class AccountInfoResponse
      ...
      def initialize(attributes = {})
        if (!attributes.is_a?(Hash))
          fail ArgumentError, "The input argument (attributes) must be a hash in `SignWell::AccountInfoResponse` initialize method"
        end
        ...
        attributes = attributes.each_with_object({}) { |(k, v), h|
          if (!acceptable_attribute_map.key?(k.to_sym))
            fail ArgumentError, "`#{k}` is not a valid attribute in `SignWell::AccountInfoResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
          h[k.to_sym] = v
        }
        ...
        if attributes.key?(:'active_templates')
          self.active_templates = attributes[:'active_templates']
        end

        if attributes.key?(:'can_create_template')
          self.can_create_template = attributes[:'can_create_template']
        end
      ...
      def ==(o)
        ...
        self.class == o.class &&
            ...
            active_templates == o.active_templates &&
            can_create_template == o.can_create_template &&
            can_create_tracking_document == o.can_create_tracking_document &&
            can_create_completion_document == o.can_create_completion_document &&
      ...
      def hash
        [id, name, plan_tier, active_templates, can_create_template, can_create_tracking_document, can_create_completion_document, active_users, preferences].hash
      end
