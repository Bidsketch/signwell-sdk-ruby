...
module SignWell
  module Resources
    class BulkSendApi
      ...
      # @return [Models::BulkSendCsvTemplateResponse or File]
      ...
      # @param [Hash] opts the optional parameters
      # @option opts [Boolean] :base64
      # @return [Array<(Models::BulkSendCsvTemplateResponse or File, Integer, Hash)>] BulkSendCsvTemplateResponse or File data, response status code and response headers
