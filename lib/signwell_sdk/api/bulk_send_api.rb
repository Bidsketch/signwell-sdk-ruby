    ...
    class BulkSendApi
      ...
      def create_bulk_send_with_http_info(create_bulk_send_request, opts = {})
        ...
        if @api_client.config.client_side_validation && create_bulk_send_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'create_bulk_send_request' when calling BulkSendApi.create_bulk_send"
        end
      ...
      def get_bulk_send_with_http_info(id, opts = {})
        ...
        if @api_client.config.client_side_validation && id.nil?
          raise ArgumentError, "Missing the required parameter 'id' when calling BulkSendApi.get_bulk_send"
        end
      ...
      def get_bulk_send_csv_template_with_http_info(template_ids, opts = {})
        ...
        if @api_client.config.client_side_validation && template_ids.nil?
          raise ArgumentError,
                "Missing the required parameter 'template_ids' when calling BulkSendApi.get_bulk_send_csv_template"
        end
        ...
        query_params[:base64] = opts[:base64] unless opts[:base64].nil?
      ...
      def get_bulk_send_documents_with_http_info(id, opts = {})
        ...
        if @api_client.config.client_side_validation && !opts[:limit].nil? && opts[:limit] < 1
          raise ArgumentError,
                'invalid value for "opts[:"limit"]" when calling BulkSendApi.get_bulk_send_documents, must be greater than or equal to 1.'
        end

        if @api_client.config.client_side_validation && !opts[:page].nil? && opts[:page] < 1
          raise ArgumentError,
                'invalid value for "opts[:"page"]" when calling BulkSendApi.get_bulk_send_documents, must be greater than or equal to 1.'
        end
      ...
      def list_bulk_sends_with_http_info(opts = {})
        @api_client.config.logger.debug 'Calling API: BulkSendApi.list_bulk_sends ...' if @api_client.config.debugging
        if @api_client.config.client_side_validation && !opts[:limit].nil? && opts[:limit] > 50
          raise ArgumentError,
                'invalid value for "opts[:"limit"]" when calling BulkSendApi.list_bulk_sends, must be smaller than or equal to 50.'
        end

        if @api_client.config.client_side_validation && !opts[:limit].nil? && opts[:limit] < 1
          raise ArgumentError,
                'invalid value for "opts[:"limit"]" when calling BulkSendApi.list_bulk_sends, must be greater than or equal to 1.'
        end

        if @api_client.config.client_side_validation && !opts[:page].nil? && opts[:page] < 1
          raise ArgumentError,
                'invalid value for "opts[:"page"]" when calling BulkSendApi.list_bulk_sends, must be greater than or equal to 1.'
        end
        ...
        # query parameters
        query_params = opts[:query_params] || {}
        query_params[:user_email] = opts[:user_email] unless opts[:user_email].nil?
        query_params[:limit] = opts[:limit] unless opts[:limit].nil?
        query_params[:page] = opts[:page] unless opts[:page].nil?
        query_params[:api_application_id] = opts[:api_application_id] unless opts[:api_application_id].nil?
      ...
      def validate_bulk_send_csv_with_http_info(bulk_send_csv_request, opts = {})
        ...
        if @api_client.config.client_side_validation && bulk_send_csv_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'bulk_send_csv_request' when calling BulkSendApi.validate_bulk_send_csv"
        end
