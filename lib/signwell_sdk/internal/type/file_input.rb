...
module SignwellSDK
  module Internal
    module Type
      ...
      # `SignwellSDK::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | SignwellSDK::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= SignwellSDK::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              SignwellSDK::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? SignwellSDK::FilePart.new(value, filename: "upload") : value
            in SignwellSDK::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
