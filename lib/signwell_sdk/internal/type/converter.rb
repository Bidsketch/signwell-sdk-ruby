    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { SignwellSDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { SignwellSDK::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            SignwellSDK::FilePart.new(value)
          in SignwellSDK::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in SignwellSDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [SignwellSDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: SignwellSDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in SignwellSDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in SignwellSDK::Internal::Type::Converter
              ...
              SignwellSDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(SignwellSDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
