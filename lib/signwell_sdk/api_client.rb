      ...
      begin
        ...
        unless response.success?
          if response.status.zero? && response.respond_to?(:return_message)
            ...
            raise Errors::ApiError.new(code: 0,
                                       message: response.return_message)
          else
            raise Errors::ApiStatusError.for(
        ...
        raise Errors::ApiTimeoutError, 'Connection timed out'
      rescue Faraday::ConnectionFailed
        raise Errors::ApiConnectionError, 'Connection failed'
      end
