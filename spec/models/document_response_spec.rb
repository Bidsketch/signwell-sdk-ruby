...
# Unit tests for SignWell::Models::DocumentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SignWell::Models::DocumentResponse do
  let(:instance) { SignWell::Models::DocumentResponse.allocate }

  describe 'test an instance of DocumentResponse' do
    it 'should create an instance of DocumentResponse' do
      expect(instance).to be_a(SignWell::Models::DocumentResponse)
    end
  end
