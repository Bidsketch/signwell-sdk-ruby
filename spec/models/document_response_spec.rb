...
# Unit tests for SignWell::DocumentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SignWell::DocumentResponse do
  let(:instance) { SignWell::DocumentResponse.new }

  describe 'test an instance of DocumentResponse' do
    it 'should create an instance of DocumentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SignWell::DocumentResponse)
    end
  end
