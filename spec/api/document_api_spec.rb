...
RSpec.describe SignWell::Resources::DocumentApi, :prism do
  ...
  describe '#create_document' do
    it 'returns DocumentResponse' do
      body = SignWell::DocumentRequest.new({ files: [SignWell::FilesInner.new({ name: 'name_example' })],
                                             recipients: [SignWell::RecipientsInner.new({ id: 'id_example',
  ...
  describe '#create_document_from_template' do
    it 'returns DocumentFromTemplateResponse' do
      body = SignWell::DocumentFromTemplateRequest.new({ recipients: [SignWell::TemplateRecipientsInner.new({
                                                                                                              id: 'id_example', email: 'signer@example.com'
                                                                                                            })] })
