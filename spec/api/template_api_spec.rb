...
RSpec.describe SignWell::Resources::TemplateApi, :prism do
  ...
  describe '#create_template' do
    it 'returns DocumentTemplateResponse' do
      body = SignWell::DocumentTemplateRequest.new({files: [SignWell::FilesInner.new({name: 'name_example'})], placeholders: [SignWell::PlaceholdersInner.new({id: 'id_example', name: 'name_example'})]})
