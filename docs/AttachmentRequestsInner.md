# SignWell::Models::AttachmentRequestsInner
...
| **recipient_id** | **String** | Unique identifier of the recipient that will view the attachment request. |  |
...
instance = SignWell::Models::AttachmentRequestsInner.new(
  name: null,
  recipient_id: null,
  required: null
)
