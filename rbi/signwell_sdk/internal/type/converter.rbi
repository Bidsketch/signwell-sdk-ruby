  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(SignwellSDK::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              SignwellSDK::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: SignwellSDK::Internal::Type::Converter::Input,
              value: T.anything,
              state: SignwellSDK::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
