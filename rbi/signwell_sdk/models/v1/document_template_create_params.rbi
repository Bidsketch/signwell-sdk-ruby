    ...
    module V1
      class DocumentTemplateCreateParams < SignwellSDK::Internal::Type::BaseModel
        ...
        class Field < SignwellSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              SignwellSDK::V1::DocumentTemplateCreateParams::Field::Type::OrSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(
                SignwellSDK::V1::DocumentTemplateCreateParams::Field::DateFormat::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                SignwellSDK::V1::DocumentTemplateCreateParams::Field::Validation::OrSymbol
              )
            )
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SignwellSDK::V1::DocumentTemplateCreateParams::Field::Type
                )
              end
            ...
            INITIALS =
              T.let(
                :initials,
                SignwellSDK::V1::DocumentTemplateCreateParams::Field::Type::TaggedSymbol
              )
            SIGNATURE =
              T.let(
                :signature,
          ...
          module DateFormat
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SignwellSDK::V1::DocumentTemplateCreateParams::Field::DateFormat
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            MM_DD_YYYY =
              T.let(
                :"MM/DD/YYYY",
                SignwellSDK::V1::DocumentTemplateCreateParams::Field::DateFormat::TaggedSymbol
              )
            DD_MM_YYYY =
              T.let(
                :"DD/MM/YYYY",
          ...
          module Validation
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SignwellSDK::V1::DocumentTemplateCreateParams::Field::Validation
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NO_TEXT_VALIDATION =
              T.let(
                :no_text_validation,
                SignwellSDK::V1::DocumentTemplateCreateParams::Field::Validation::TaggedSymbol
              )
            NUMBERS =
              T.let(
                :numbers,
