    ...
    module V1
      class DocumentRetrieveParams < SignwellSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              SignwellSDK::V1::DocumentRetrieveParams,
        ...
        module FileFormat
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, SignwellSDK::V1::DocumentRetrieveParams::FileFormat)
            end
          ...
          PDF =
            T.let(
              :pdf,
              SignwellSDK::V1::DocumentRetrieveParams::FileFormat::TaggedSymbol
            )
          ZIP =
            T.let(
              :zip,
