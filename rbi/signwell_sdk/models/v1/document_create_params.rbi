    ...
    module V1
      class DocumentCreateParams < SignwellSDK::Internal::Type::BaseModel
        ...
        class Field < SignwellSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              SignwellSDK::V1::DocumentCreateParams::Field::Type::OrSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(
                SignwellSDK::V1::DocumentCreateParams::Field::DateFormat::OrSymbol
              )
            )
          end
            ...
            returns(
              T.nilable(
                T::Array[
                  T.any(
                    String,
                    SignwellSDK::V1::DocumentCreateParams::Field::Option::UnionMember1
                  )
                ]
              )
            )
            ...
            params(
              options:
                T::Array[
                  T.any(
                    String,
                    SignwellSDK::V1::DocumentCreateParams::Field::Option::UnionMember1::OrHash
                  )
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                SignwellSDK::V1::DocumentCreateParams::Field::Validation::OrSymbol
              )
            )
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SignwellSDK::V1::DocumentCreateParams::Field::Type
                )
              end
            ...
            INITIALS =
              T.let(
                :initials,
                SignwellSDK::V1::DocumentCreateParams::Field::Type::TaggedSymbol
              )
            SIGNATURE =
              T.let(
                :signature,
          ...
          module DateFormat
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SignwellSDK::V1::DocumentCreateParams::Field::DateFormat
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            MM_DD_YYYY =
              T.let(
                :"MM/DD/YYYY",
                SignwellSDK::V1::DocumentCreateParams::Field::DateFormat::TaggedSymbol
              )
            DD_MM_YYYY =
              T.let(
                :"DD/MM/YYYY",
          ...
          module Validation
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SignwellSDK::V1::DocumentCreateParams::Field::Validation
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            NO_TEXT_VALIDATION =
              T.let(
                :no_text_validation,
                SignwellSDK::V1::DocumentCreateParams::Field::Validation::TaggedSymbol
              )
            NUMBERS =
              T.let(
                :numbers,
