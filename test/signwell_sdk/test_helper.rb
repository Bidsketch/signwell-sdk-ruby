...
class SignwellSDK::Test::SingletonClient < SignwellSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: SignwellSDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class SignwellSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @signwell_sdk = SignwellSDK::Test::SingletonClient.instance
  end
