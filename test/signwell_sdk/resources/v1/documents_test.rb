  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        checkbox_groups: ^(SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::CheckboxGroupInfo]) | nil,
        copied_contacts: ^(SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::CopiedContactInfo]) | nil,
        created_at: Time | nil,
        ...
        files: ^(SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::FileInfo]) | nil,
        labels: ^(SignwellSDK::Internal::Type::ArrayOf[SignwellSDK::LabelInfo]) | nil,
        language: String | nil,
        message: String | nil,
