...
class SignwellSDKTest < Minitest::Test
  ...
  def test_raises_on_missing_non_nullable_opts
    e = assert_raises(ArgumentError) do
      SignwellSDK::Client.new
    end
    assert_match(/is required/, e.message)
  end

  def test_client_default_request_default_retry_attempts
    stub_request(:get, "http://localhost/api/v1/documents").to_return_json(status: 500, body: {})

    signwell_sdk = SignwellSDK::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(SignwellSDK::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    signwell_sdk =
      SignwellSDK::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(SignwellSDK::Errors::InternalServerError) do
      signwell_sdk.v1.documents.list(request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(SignwellSDK::Errors::InternalServerError) do
      signwell_sdk.v1.documents.list(request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    stub_request(:get, "http://localhost/api/v1/documents").to_return_json(
      status: 500,
    ...
    signwell_sdk =
      SignwellSDK::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_omit_retry_count_header
    ...
    assert_raises(SignwellSDK::Errors::InternalServerError) do
      signwell_sdk.v1.documents.list(request_options: {extra_headers: {"x-stainless-retry-count" => nil}})
    end
  ...
  def test_overwrite_retry_count_header
    ...
    assert_raises(SignwellSDK::Errors::InternalServerError) do
      signwell_sdk.v1.documents.list(request_options: {extra_headers: {"x-stainless-retry-count" => "42"}})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raises(SignwellSDK::Errors::APIConnectionError) do
      signwell_sdk.v1.documents.list(request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: SignwellSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: SignwellSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    assert_raises(SignwellSDK::Errors::APIConnectionError) do
      signwell_sdk.v1.documents.list(request_options: {extra_headers: {"authorization" => "Bearer xyz"}})
    end
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: SignwellSDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:get, "http://localhost/api/v1/documents").to_return_json(status: 200, body: {})
