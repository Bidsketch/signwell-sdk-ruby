...
class SignwellSDK::Test::PrimitiveModelTest < Minitest::Test
  A = SignwellSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = SignwellSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < SignwellSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      SignwellSDK::Internal::Type::Unknown,
      SignwellSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => SignwellSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [SignwellSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [SignwellSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [SignwellSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = SignwellSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        SignwellSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [SignwellSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [SignwellSDK::Internal::Type::Boolean, true] => true,
      [SignwellSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => SignwellSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        SignwellSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = SignwellSDK::Internal::Type::Converter.new_coerce_state
      SignwellSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        SignwellSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class SignwellSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include SignwellSDK::Internal::Type::Enum
...
class SignwellSDK::Test::CollectionModelTest < Minitest::Test
  A1 = SignwellSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = SignwellSDK::Internal::Type::HashOf[Integer]

  A2 = SignwellSDK::Internal::Type::ArrayOf[H1]
  H2 = SignwellSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = SignwellSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = SignwellSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class SignwellSDK::Test::BaseModelTest < Minitest::Test
  class M1 < SignwellSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < SignwellSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < SignwellSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, SignwellSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = SignwellSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = SignwellSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(SignwellSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue SignwellSDK::Errors::ConversionError => e
...
class SignwellSDK::Test::UnionTest < Minitest::Test
  class U0
    include SignwellSDK::Internal::Type::Union
  ...
  class M2 < SignwellSDK::Internal::Type::BaseModel
  ...
  class M4 < SignwellSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, SignwellSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < SignwellSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, SignwellSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class SignwellSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include SignwellSDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [SignwellSDK::Internal::Type::Unknown, SignwellSDK::Internal::Type::Unknown] => true,
      [SignwellSDK::Internal::Type::Boolean, SignwellSDK::Internal::Type::Boolean] => true,
      [SignwellSDK::Internal::Type::Unknown, SignwellSDK::Internal::Type::Boolean] => false,
...
class SignwellSDK::Test::MetaInfoTest < Minitest::Test
  A1 = SignwellSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = SignwellSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
